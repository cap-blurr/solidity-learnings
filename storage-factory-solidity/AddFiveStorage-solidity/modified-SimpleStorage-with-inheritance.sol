...
contract SimpleStorage {
    ...
    function store(uint256 _favoritenumber) public virtual {
        ...
        // we have modified this function by adding the virtual keyword so that we can modify it in the AddFiveStorage contract using the "override" keyword 
        // any function without the "virtual" keyword cannot be overriden
    }
